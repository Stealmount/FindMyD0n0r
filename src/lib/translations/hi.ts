...
export const hi: TranslationDictionary = {
  account: {
    ...
    donorDashboard: {
      ...
      units: 'यूनिट',
      componentLabel: 'कंपोनेंट',
      urgency: 'तात्कालिकता',
      contactRequester: 'अनुरोधकर्ता से संपर्क करें',
      callRequester: 'कॉल करें',
      requesterName: 'अनुरोधकर्ता का नाम',
      requesterPhone: 'अनुरोधकर्ता का फ़ोन',
      trackingLabel: 'ट्रैकिंग कोड',
      timeline: 'अनुरोध समयरेखा',
      stepRequestCreated: 'अनुरोध बनाया गया',
      stepLiveMatching: 'लाइव मैचिंग',
      stepDonorResponded: 'रक्तदाता ने जवाब दिया',
      stepMatchConfirmed: 'मैच की पुष्टि',
      stepRequestFulfilled: 'अनुरोध पूरा हुआ',
      stepDonationCompleted: 'रक्तदान पूरा हुआ',
       trackRequest: 'इस अनुरोध को ट्रैक करें',
       contactUnlockHint: 'स्वीकार करने पर अनुरोधकर्ता के लिए आपका संपर्क विवरण खुल जाता है।',
       acceptedChip: 'स्वीकृत',
       iCanDonate: 'मैं दान कर सकता/सकती हूँ',
       whatsappRequester: 'व्हाट्सएप करें',
       openInMap: 'मैप में खोलें',
       trackMatch: 'मैच ट्रैक करें',
     },
    requesterDashboard: {
